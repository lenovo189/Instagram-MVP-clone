    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-3 sm:p-4 border-b border-border sticky top-0 bg-card/80 backdrop-blur-md z-10">
          <h3 className="text-base sm:text-lg font-semibold text-foreground">{t.profile.editProfile}</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-3 sm:p-4 overflow-y-auto max-h-[calc(90vh-8rem)]">
          <div className="flex flex-col items-center">
            <div className="relative w-24 h-24 sm:w-28 sm:h-28 hover-scale transition-transform">
              <Image
            ...
            <label
              ...
              className="mt-3 text-sm font-semibold text-primary cursor-pointer hover:text-primary/80 transition-colors hover-lift"
            >
          ...
          <div className="mt-6 space-y-4">
            <div>
              <label htmlFor="display-name" className="block text-sm font-medium text-muted-foreground mb-1">
                {t.auth.displayName}
              </label>
              <input
                type="text"
                ...
                className="w-full p-2.5 text-sm sm:text-base bg-muted/30 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary transition-all"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-2.5 text-sm sm:text-base bg-muted/30 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary transition-all resize-none"
                rows={3}
              ></textarea>
            </div>
          </div>
